...
$checkemail = "SELECT * FROM users WHERE email = '$email'";
    ...
    echo  "<center><font color='red'>Email is already taken! try a different one</font></center>";
      ...
      $query = "INSERT INTO users(username,name,email,password,role,gender,joindate,about) VALUES ('$username' , '$name' , '$email', '$password' , '$role', '$gender' , '$joindate' , '$phone' )";
...
<div class="container">
      ...
      <div  class="form">
        <form id="contactform" action="#" method="POST"> 
          ...
          <input id="name" name="name" placeholder="Name" required="" tabindex="1" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['name']; } ?>"> 
          ...
          <input id="phone" name="phone" placeholder="+91" required="" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['phone']; } ?>"> 
